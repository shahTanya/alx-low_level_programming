...
void print_smprm(int smprm);
int gcd(int a, int b);
long int int2mod(long int num, long int mod);
long int mod_inverse(long int num, long int mod);
long int bigpwr2mod(long int base, long int idx, long int mod);
long int encrypt(long int data);
long int *encrypt2(char *type, ...);
long int decrypt(long int ciphertext);
char *decrypt2(long int *ciphertext);
